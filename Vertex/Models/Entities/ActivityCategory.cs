...
public static class ActivityCategory
{
    public static readonly Dictionary<string, ReadOnlyCollection<Brush>> Categories =
        ...
        { 
            { "Home & Maintenance", new List<Brush> {
                GetBrush("#FFCC99"),
                GetBrush("#FFB366"),
                GetBrush("#FF9944"),
                GetBrush("#E07020"),
            ...
            { "Social & Relationships", new List<Brush> {
                GetBrush("#C9AAF0"),
                GetBrush("#AA77E4"),
                GetBrush("#8F55D6"),
                GetBrush("#6228B0"),
            ...
            { "Administration & Logistics", new List<Brush> {
                GetBrush("#EBA8C4"),
                GetBrush("#D97AA0"),
                GetBrush("#C8527A"),
                GetBrush("#9E2050"),
